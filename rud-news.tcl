...
## headerstyle
set news(header) "\0037\002\[NEWS\]:\002 - !news for a longer list\003"
...
bind pub - !addnews rud:pub:addnews
bind msg o !addnews rud:msg:addnews
bind pub - !delnews rud:pub:delnews
...
proc rud:msg:delnews { nick uhost handle arg } {
	...
	if { [info exists adder] } {
		...
		#file rename -force $news(file) $news(file)
